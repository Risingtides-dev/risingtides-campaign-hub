...
The clients are **record labels** — companies like Warner Music, Atlantic Records, and others. They pay Rising Tides to run User Generated Content (UGC) campaigns: they want real creators on TikTok and Instagram to post videos using a specific song.
